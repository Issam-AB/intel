...
const CallLog = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Grid container justify="center" alignItems="center" spacing={4} style={{ marginTop: "1rem" }} classes={{ root: classes.root }}>
                <Grid item style={{ textAlign: "center" }}>
                    ...
                    >
                        Select one our custom integrations to sync your data with Roofing intellegence or send your leads somewhere else! Don't see your desired integration? Contact us for a custom integration quote.
                    ...
                    <Box display="flex" style={{ marginTop: "1rem" }}>
                        ...
                        <Button variant="primary" classes={{ primary: classes.primary, label: classes.textButton }}>
                            Search
                        </Button>
