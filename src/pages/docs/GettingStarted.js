  ...
  return (
    <Box mb={10}>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        . You'll need to install Node.js (v12 or up) before using Roofing
        intellegence.
      </Typography>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        Roofing intellegence's dependencies. All dependencies will be downloaded
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        <code>build/</code>
        files. Roofing intellegence is using webpack and webpack-serve to
