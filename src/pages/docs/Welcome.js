  ...
  return (
    <Box mb={10}>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        Hello, I hope you find this theme useful. Roofing intellegence has been
        crafted on top of Material UI. The included demo pages don't replace the
        ...
        <ul>
          ...
          <li>
            <Link
              component={NavLink}
              exact
              to="/documentation/environment-variables"
            >
              Environment Variables
            </Link>
          </li>
          <li>
            <Link component={NavLink} exact to="/documentation/deployment">
              Deployment
            </Link>
          </li>
          <li>
            <Link component={NavLink} exact to="/documentation/theming">
              Theming
            </Link>
          </li>
          <li>
            <Link
              component={NavLink}
              exact
              to="/documentation/state-management"
            >
              State Management
            </Link>
          </li>
          <li>
            <Link component={NavLink} exact to="/documentation/api-calls">
              API Calls
            </Link>
          </li>
          <li>
            <Link
              component={NavLink}
              exact
              to="/documentation/eslint-and-prettier"
            >
              ESLint & Prettier
            </Link>
          </li>
          <li>
            <Link component={NavLink} exact to="/documentation/support">
              Support
            </Link>
          </li>
          <li>
            <Link component={NavLink} exact to="/changelog">
              Changelog
            </Link>
          </li>
        </ul>
